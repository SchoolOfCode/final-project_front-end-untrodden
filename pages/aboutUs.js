    ...
    <>
      ...
      <Link href="/">
        <img
          ...
          src="/Inline-logo-whiteandblack.png"
          alt="Untrodden"
        />
      </Link>
        ...
        <section className={styles.about_us_mid}>
          <section className={styles.about_us_description_container}>
            ...
            <p className={styles.about_us_description_paragraph}>
              ...
              beautiful locations you may not have known the UK has to offer.
            </p>
            <p className={styles.about_us_description_paragraph}>
              Why not join our community, discovering and sharing secretd places
              areoun the UK.
            </p>
          </section>
